...
public class CaffeineTile extends QSTileImpl<BooleanState> {
    ...
    public CaffeineTile(QSHost host) {
        super(host);
        mWakeLock = mContext.getSystemService(PowerManager.class).newWakeLock(PowerManager.FULL_WAKE_LOCK, "CaffeineTile");
        mReceiver.init();
    }
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        state.contentDescription =  mContext.getString(state.value ? R.string.accessibility_quick_settings_caffeine_on : R.string.accessibility_quick_settings_caffeine_off);
